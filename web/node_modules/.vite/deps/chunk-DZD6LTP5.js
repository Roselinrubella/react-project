...
var DropdownMenu2 = React4.forwardRef(({
  bsPrefix,
  className,
  align,
  rootCloseEvent,
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react5.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react5.useContext)(DropdownContext_default2);
...
export {
  ...
  DropdownContext_default2 as DropdownContext_default,
  InputGroupContext_default,
  alignPropType,
  getDropdownMenuPlacement,
  DropdownMenu_default2
};
//# sourceMappingURL=chunk-DZD6LTP5.js.map
