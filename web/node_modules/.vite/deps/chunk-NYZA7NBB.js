...
var NavbarOffcanvas = React.forwardRef(({
  onHide,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime.jsx)(Offcanvas_default, {
    ref,
...
var NavbarText = React2.forwardRef(({
  className,
  bsPrefix,
  as: Component = "span",
  ...props
...
var Navbar = React3.forwardRef((props, ref) => {
  const {
  ...
  const handleCollapse = (0, import_react2.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react2.useMemo)(() => ({
    onToggle: () => onToggle == null ? void 0 : onToggle(!expanded),
    bsPrefix,
    expanded: !!expanded,
    expand
  }), [bsPrefix, expanded, expand, onToggle]);
  return (0, import_jsx_runtime3.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime3.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime3.jsx)(Component, {
        ref,
        ...controlledProps,
        className: (0, import_classnames2.default)(className, bsPrefix, expand && expandClass, variant && `${bsPrefix}-${variant}`, bg && `bg-${bg}`, sticky && `sticky-${sticky}`, fixed && `fixed-${fixed}`)
      })
    })
  });
});
...
//# sourceMappingURL=chunk-NYZA7NBB.js.map
